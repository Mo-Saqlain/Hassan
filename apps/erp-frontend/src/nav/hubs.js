...
export const HUBS = {
  customer: {
    ...
    title: 'Customers',
    subtitle:
      'Customer info, receipts received, ledger, warranty lookup, and service tickets.',
    icon: 'user',
    ...
    tabs: [
      ...
      { to: '/service-tickets', label: 'Service', icon: 'sparkles' },
    ],
  },
  sales: {
    label: 'Sales',
  ...
  stock: {
    ...
    tabs: [
      ...
      { to: '/stocktake', label: 'Stocktake', icon: 'master' },
      { to: '/reorder', label: 'Reorder', icon: 'packageX' },
    ],
  },
  employee: {
    label: 'Employee',
  ...
  account: {
    ...
    defaultTo: '/accounts',
    paths: ['/accounts', '/fund-transfers', '/expenses', '/account-ledger'],
    tabs: [
      { to: '/accounts', label: 'Info', icon: 'bank' },
      { to: '/fund-transfers', label: 'Transfers', icon: 'transfer' },
      { to: '/expenses', label: 'Expenses', icon: 'card' },
